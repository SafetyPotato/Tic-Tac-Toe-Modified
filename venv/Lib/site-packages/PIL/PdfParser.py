...
class PdfParser:
    """Based on
    https://www.adobe.com/content/dam/acom/en/devnet/acrobat/pcountMarkers/PDF32000_2008.pdf
    ...
    def get_value(cls, data, offset, expect_indirect=None, max_nesting=-1):
        ...
        if m:
            ...
            if m:
                ...
                offset = m.end()
                result = PcountMarkerstream(PdfDict(result), stream_data)
            else:
